...
export const projects = [
  { id: '1', titulo: 'E-commerce ModaFácil',        descricao: 'Plataforma completa de vendas online com painel admin, carrinho e pagamento integrado.', categorias: ['Desenvolvimento', 'Design'],     tecnologias: ['React', 'Node.js', 'MongoDB'],      imagemUrl: 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=600&fit=crop',  destaque: true  },
  { id: '2', titulo: 'App de Agendamento MedFácil',  descricao: 'Aplicativo mobile para agendamento de consultas médicas com notificações em tempo real.',  categorias: ['Mobile', 'Saúde'],               tecnologias: ['React Native', 'Firebase'],          imagemUrl: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&fit=crop',   destaque: true  },
  { id: '3', titulo: 'Dashboard Financeiro FinView',  descricao: 'Painel de gestão financeira com gráficos interativos e relatórios exportáveis.',          categorias: ['Desenvolvimento', 'Dashboard'],   tecnologias: ['Vue.js', 'Node.js', 'PostgreSQL'],  imagemUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&fit=crop',   destaque: false },
  { id: '4', titulo: 'Site Institucional AdvSouza',   descricao: 'Site moderno e responsivo para escritório de advocacia com blog e área do cliente.',      categorias: ['Design', 'Web'],                 tecnologias: ['Next.js', 'Tailwind CSS'],           imagemUrl: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&fit=crop',   destaque: false },
  { id: '5', titulo: 'Sistema de Gestão EduTrack',    descricao: 'Plataforma educacional com gestão de alunos, notas, frequência e comunicados.',           categorias: ['Desenvolvimento', 'Educação'],    tecnologias: ['React', 'Express', 'MySQL'],         imagemUrl: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=600&fit=crop',   destaque: true  },
  { id: '6', titulo: 'Landing Page NovaPay',          descricao: 'Landing page de alta conversão para fintech com animações e integração de formulários.',  categorias: ['Design', 'Web'],                 tecnologias: ['Next.js', 'Framer Motion'],          imagemUrl: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=600&fit=crop',  destaque: false },
];
