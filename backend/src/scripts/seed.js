...
const projectsData = [
  {
    ...
    descricao: 'Plataforma de e-commerce completa para loja de moda com catálogo de produtos, carrinho, checkout e painel administrativo.',
  ...
  },
  {
    ...
    categorias: ['Mobile', 'Design'],
    tecnologias: ['React Native', 'Firebase', 'Expo'],
    imagemUrl: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=800',
    destaque: true,
    ativo: true,
  },
  {
    ...
    tecnologias: ['Next.js', 'PostgreSQL', 'Express', 'Docker'],
  ...
  },
  {
    ...
    categorias: ['Dashboard', 'Desenvolvimento'],
    tecnologias: ['Vue.js', 'D3.js', 'PostgreSQL', 'Redis'],
  ...
  },
  {
    ...
    categorias: ['Desenvolvimento', 'Web'],
    tecnologias: ['Node.js', 'Stripe', 'MongoDB', 'AWS'],
